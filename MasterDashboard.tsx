...
export const MasterDashboard: React.FC = () => {
  ...
  const handleExtend = async (id: string, plan: PlanType, days: number) => {
    if(window.confirm(`Deseja liberar mais ${days} dias de acesso para esta oficina?`)) {
                ...
                return (
                  <tr key={c.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2 flex items-center">
                       ...
                       <button 
                          onClick={() => handleExtend(c.id, c.plan, 30)}
                          title="Liberar +30 Dias"
                          className="text-blue-600 hover:text-white hover:bg-blue-600 bg-blue-50 p-2 rounded-lg transition-colors flex items-center gap-1"
                       >
                          <Calendar size={16} />
